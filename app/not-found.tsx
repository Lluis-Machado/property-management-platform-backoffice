const NotFound = (): React.ReactElement => (
    <main className='grid h-screen place-items-center bg-white px-6 py-24 font-barlow sm:py-32 lg:px-8'>
        <div className='text-center'>
            ...
            <div className='mt-10 flex items-center justify-center gap-x-6'>
                ...
                <a
                    href="mailto:support@plattesgroup.net?subject=Couldn't%20find%20requested%20page"
